...
st.write("* 🗺️SIG: traitement de données sur QGIS et ArcGIS.") 
st.write("* 🖥️Python: écrire des lignes de codes, créer des applications.") 
st.write("* 🌍GPS: localiser des sites.")  
st.write("* 🛰️Télédétection") 
st.write("* ✏️ AutoCad: dessiner des plans en 2D.")
...
with st.sidebar:
    st.image("Ma photo.jpeg",width=150) 
    st.write("👷‍♀️Technicienne Supérieure en Géomatique") 
    st.write("Nom: Khady") 
    st.write("Prénom: DIOP") 
    st.write("📞Téléphone: 77-299-90-55") 
    st.write("📧 E-mail: khadydiop060105@gmail.com") 
    st.header("Diplomes")
